        ...
        try {
          ...
          if (topicConfig) {
            ...
            if (value) {
              ...
              console.log("Kafka Consumer: Processing message for topic", topic);
              console.log("Kafka Consumer: Parsed data keys:", Object.keys(parsedData));
              await topicConfig.topicHandler({ value: parsedData });
            }
          }
        } catch (error) {
