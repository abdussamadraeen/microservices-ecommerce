...
const InvoiceView = ({ order, settings }: InvoiceViewProps) => {
    // Calculations (moved from page.tsx)
    const taxRate = 0.18;
    const totalAmount = order.amount / 100; // in cents
    const baseAmount = totalAmount / (1 + taxRate);
    const taxAmount = totalAmount - baseAmount;

    return (
        <div className="min-h-screen bg-gray-100 print:bg-white print:p-0 p-8 flex flex-col justify-start items-center gap-6">
            {/* Print Controls */}
